...
export type BalancerV2PoolQueryVariables = Exact<{ [key: string]: never; }>;


export type BalancerV2PoolQuery = { __typename?: 'Query', pool?: { __typename?: 'Pool', id: string, totalLiquidity: any, totalShares: any, tokens?: Array<{ __typename?: 'PoolToken', balance: any, symbol: string }> | null } | null };


export const BalancerV2PoolDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    BalancerV2Pool(variables?: BalancerV2PoolQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<BalancerV2PoolQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<BalancerV2PoolQuery>(BalancerV2PoolDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'BalancerV2Pool', 'query');
    }
  };
}
...
export function getSdkWithHooks(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  ...
  return {
    ...sdk,
    useBalancerV2Pool(variables?: BalancerV2PoolQueryVariables, config?: SWRConfigInterface<BalancerV2PoolQuery, ClientError>) {
      return useSWR<BalancerV2PoolQuery, ClientError>(genKey<BalancerV2PoolQueryVariables>('BalancerV2Pool', variables), () => sdk.BalancerV2Pool(variables), config);
    }
  };
}
