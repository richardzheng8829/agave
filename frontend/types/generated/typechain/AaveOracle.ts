...
export interface AaveOracleInterface extends utils.Interface {
  ...
  events: {
    ...
    "WrappedNativeSet(address)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "WrappedNativeSet"): EventFragment;
}
...
export interface WrappedNativeSetEventObject {
  wrappedNative: string;
}
export type WrappedNativeSetEvent = TypedEvent<
  [string],
  WrappedNativeSetEventObject
>;

export type WrappedNativeSetEventFilter =
  TypedEventFilter<WrappedNativeSetEvent>;
...
export interface AaveOracle extends BaseContract {
  ...
  filters: {
    ...
    "WrappedNativeSet(address)"(
      wrappedNative?: PromiseOrValue<string> | null
    ): WrappedNativeSetEventFilter;
    WrappedNativeSet(
      wrappedNative?: PromiseOrValue<string> | null
    ): WrappedNativeSetEventFilter;
  };
