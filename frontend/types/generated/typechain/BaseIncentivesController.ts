...
export interface BaseIncentivesControllerInterface extends utils.Interface {
  functions: {
...
export type DistributionEndUpdatedEventFilter =
  TypedEventFilter<DistributionEndUpdatedEvent>;
...
export type RewardsVaultUpdatedEvent = TypedEvent<
  [string],
  RewardsVaultUpdatedEventObject
>;

export type RewardsVaultUpdatedEventFilter =
  TypedEventFilter<RewardsVaultUpdatedEvent>;
...
export interface BaseIncentivesController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseIncentivesControllerInterface;
  ...
  filters: {
    ...
    ): DistributionEndUpdatedEventFilter;
    ...
    "RewardsVaultUpdated(address)"(
      vault?: PromiseOrValue<string> | null
    ): RewardsVaultUpdatedEventFilter;
    RewardsVaultUpdated(
      vault?: PromiseOrValue<string> | null
    ): RewardsVaultUpdatedEventFilter;
