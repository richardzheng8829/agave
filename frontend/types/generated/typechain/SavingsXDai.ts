...
export interface SavingsXDaiInterface extends utils.Interface {
  functions: {
...
export interface SavingsXDai extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SavingsXDaiInterface;
  ...
  functions: {
    ...
    decreaseAllowance(
      spender: PromiseOrValue<string>,
      requestedDecrease: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
