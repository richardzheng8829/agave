...
interface ErrorsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "LP_MAX_BORROWED()": FunctionFragment;
    "LP_MAX_DEPOSITED()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "LP_MAX_BORROWED",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "LP_MAX_DEPOSITED",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class Errors extends Contract {
  ...
  functions: {
    ...
    LP_MAX_BORROWED(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
    ...
    LP_MAX_DEPOSITED(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  LP_MAX_BORROWED(overrides?: CallOverrides): Promise<string>;

  "LP_MAX_BORROWED()"(overrides?: CallOverrides): Promise<string>;

  LP_MAX_DEPOSITED(overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    LP_MAX_BORROWED(overrides?: CallOverrides): Promise<BigNumber>;

    "LP_MAX_BORROWED()"(overrides?: CallOverrides): Promise<BigNumber>;

    LP_MAX_DEPOSITED(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    LP_MAX_BORROWED(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "LP_MAX_BORROWED()"(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;

    LP_MAX_DEPOSITED(overrides?: CallOverrides): Promise<PopulatedTransaction>;
